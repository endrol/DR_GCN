...
parser.add_argument('--data', metavar='DIR',default='/home/kamatalab/ML_GCN-master/data/coco',
...
parser.add_argument('--resume', default='/home/kamatalab/ML_GCN-master/checkpoint/coco/coco_checkpoint.pth.tar', type=str, metavar='PATH',
