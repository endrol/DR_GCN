...
parser.add_argument('--data', metavar='DIR',default='/home/kamatalab/ML_GCN-master/data/voc',
...
# parser.add_argument('--resume', default='/home/kamatalab/ML_GCN-master/checkpoint/voc/voc_checkpoint.pth.tar', type=str, metavar='PATH',
...
def main_voc2007():
    ...
    state['save_model_path'] = 'checkpoint/voc_new_model/'
