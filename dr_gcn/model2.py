...
class GCNResnet(nn.Module):
    ...
    def forward(self, feature, inp):
        # print('check nan begin ', feature.shape)
        # print('check nan begin ', inp.shape)
        feature = self.features(feature)
        # print('features is ', feature)
        feature = self.pooling(feature)
        # print('features2 is ', feature)
        feature = feature.view(feature.size(0), -1)
        # print('features3 is ', feature)
        inp = inp[0]
        # print('inp is ', inp)
        # print('even more check A', self.A)
        adj1 = gen_adj(self.A)
...
def gcn_resnet101(num_classes, t, pretrained=True, adj_file=None, in_channel=64):
