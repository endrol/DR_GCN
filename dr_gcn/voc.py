...
class Voc2007Classification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None, inp_name=None, adj=None):
        ...
        print('images shape length ',len(self.images))
        print('images[0] is ', self.images[0])
        # path, target = self.images[index]
        # 打开pkl文件
        '''
        voc_adj dict{'nums': 20, 'adj':20*20}, nums应该是指不同的feature label,数字本身没有意义
        voc_glove_word2vec numpy_addray 20*300, 20 different feature vectors
        '''
